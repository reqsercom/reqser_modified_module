...
class ApiBase {
  ...
  /**  
   * public method update_module_version
   *
   * @return boolean
   */
  public function update_module_version($reqser_module_version) {
    ...
    $upd_conf_qu_str = "UPDATE configuration SET configuration_value = '".$reqser_module_version."' WHERE configuration_key = ?";
