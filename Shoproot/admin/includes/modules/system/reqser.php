...
class reqser {
  ...
  function __construct() {
    ...
    if($local_api_key != '' && $this->check() !== false && $reqser_update_request !== true) {
      ...
      if(!isset($token_verify['warning_message'])){
        ...
        $post_fields = array('cms' => 'Modified','cms_major_version' => PROJECT_MAJOR_VERSION, 'cms_minor_version' => PROJECT_MINOR_VERSION, 'php_version' => phpversion(), 'module_version' => $this->module_version);
  ...
  function install() {
    ...
    $default_tables = 'categories_description,content_manager,orders_status,products_description,products_options,products_options_values';
