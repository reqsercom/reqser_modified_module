...
define('MODULE_SYSTEM_REQSER_VERIFY_KEY_ON_SAVE_TITLE', 'API-Key pr&uuml;fen ?');
define('MODULE_SYSTEM_REQSER_VERIFY_KEY_ON_SAVE_DESC', 'API-Key beim Speichern des Modules live &uuml;berpr&uuml;fen ?');
