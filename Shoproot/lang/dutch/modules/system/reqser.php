...
define('MODULE_SYSTEM_REQSER_LANGUAGE_FILES_SETTING_DESC', 'Moeten de vertaalde taalbestanden automatisch naar uw shop worden overgedragen of moet elk taalbestand handmatig worden geselecteerd in Reqser?<br />Ja = taalbestanden automatisch overdragen / Nee = handmatig overdragen');
...
define('MODULE_SYSTEM_REQSER_DISABLE_BASE_LANGUAGE_EDIT_TITLE', 'Bewerking van de basistaal voorkomen?');
define('MODULE_SYSTEM_REQSER_DISABLE_BASE_LANGUAGE_EDIT_DESC', 'Bewerken van de basistaal moet worden toegestaan, zodat zoekmachineoptimalisatie van de teksten in de basistaal kan plaatsvinden.<br />Ja = Bewerken verhinderen / Nee = Bewerken toestaan');
define('MODULE_SYSTEM_REQSER_SANITIZE_STRINGS_TITLE', 'Moeten "scripte" en "iframe" uit de teksten worden verwijderd?');
define('MODULE_SYSTEM_REQSER_SANITIZE_STRINGS_DESC', 'Als er bijvoorbeeld YouTube-video\'s of animaties in de teksten zijn opgenomen, mogen deze tags niet worden verwijderd. Anders kunnen de teksten die wij bewerken hun functionaliteit verliezen.<br />Ja = Verwijderen / Nee = Niet verwijderen');
...
define('MODULE_SYSTEM_REQSER_API_KEY_WRONG_ERR', 'De "Reqser API key" die hier in de module is opgeslagen komt niet overeen met de key die bij <i>reqser.com</i> is opgeslagen.<br />Log in op <i>reqser</i>.com en controleer de API-sleutel of haal hem indien nodig opnieuw op en sla hem hier op.');
define('MODULE_SYSTEM_REQSER_API_KEY_SUCCESS', 'API-sleutel succesvol opgeslagen');
define('MODULE_SYSTEM_REQSER_API_KEY_EMPTY_ERR', 'Er is geen API-sleutel ingevoerd! Log in op <i>reqser.com</i> en vraag de API-sleutel voor deze website op en sla deze hier op in de module.');
...
define('MODULE_SYSTEM_REQSER_TABLE_NOT_EXIST_ERR', 'De handmatig toegevoegde tabel <b>"%s"</b> kon niet worden gevonden in de database.' . MODULE_SYSTEM_REQSER_MORE_TABLES_TITLE . ' Controleer de instellingen voor " "!');
...
define('MODULE_SYSTEM_REQSER_ADMIN_CATEGORIES_SEO_SETTINGS_LOADING', 'SEO-instellingen worden geladen, een ogenblik geduld alstublieft.');
define('MODULE_SYSTEM_REQSER_ADMIN_CATEGORIES_SEO_FORM_PARAMS_MISSING', 'Je invoer is niet compleet, controleer dit alstublieft:');