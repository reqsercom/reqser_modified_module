...
***********************************************************/
define('MODULE_SYSTEM_REQSER_TITLE', 'AI инструменти за преводи и SEO чрез Reqser <i>.</i>com, версия на модула %s<br />- изграждане за <i>Reqser</i>.com -<br />&copy; <a href="http://www.revilonetz.de/kontakt" target="_blank" title="Kontaktiere noRiddle" style="color:#02afc3;">noRiddle</a> и &copy; <a href="https://www.reqser.com" target="_blank" title="Kontaktiere Reqser" style="color:#02afc3;">Reqser.com</a> ' . date('m-Y') . '(07-2023 - )');
define('MODULE_SYSTEM_REQSER_DESCRIPTION', '
<a href="https://www.reqser.com" target="_blank"><img src="images/reqser_modul/modul_logo.png" border=0 width="400px"></a></br> Системен модул за връзка с DeepL, OpenAI и Neuroflash чрез <i><a href="https://reqser.com/" target="_blank">reqser.com</a></i>');
...
define('MODULE_SYSTEM_REQSER_LESS_TABLES_DESC', 'Въведете тук таблиците, които да бъдат изключени от преводите, разделени със запетаи.<br />(Необходимо е само ако всички стандартни таблици са избрани по-горе и някои от тях трябва да бъдат изключени).');
...
define('MODULE_SYSTEM_REQSER_ADD_LANGUAGE_ALLOWED_DESC', '<a href="https://reqser.com/" target="_blank"></a> Ако тази настройка е зададена на "Да", в <i>reqser.com</i> могат да се добавят нови езици.<br />При настройка "Не" езикът вече трябва да съществува в системата на магазина и да бъде активиран в този модул.<br />Създаване на език в магазина: <a href="' . DIR_WS_ADMIN . FILENAME_LANGUAGES . '">&amp;raquo Създаване на език в магазина ?</a> &nbsp;&nbsp;<span class="alrt">!! Новият език е достъпен в магазина само след 24-48 часа. !!</span><br />След това маркирайте тук като език за превод');
define('MODULE_SYSTEM_REQSER_LANGUAGE_FILES_TITLE', '' . draw_tooltip('Превод на езиковите файлове на сървъра? Всички файлове на сървъра се превеждат</br>Това се отнася и за езиковите файлове на модулите и разширенията. Всички езикови файлове се възстановяват, включително съществуващите езици.<br />По подразбиране съществуващите чуждоезикови текстове в Reqser се приемат, а не се превеждат наново, но това може да се промени в настройките на Reqser.'));
...
define('MODULE_SYSTEM_REQSER_DISABLE_BASE_LANGUAGE_EDIT_TITLE', 'Предотвратяване на редактирането на основния език?');
define('MODULE_SYSTEM_REQSER_DISABLE_BASE_LANGUAGE_EDIT_DESC', 'Редактирането на основния език трябва да бъде разрешено, за да може да се извърши оптимизация на текстовете за търсачките на основния език.<br />Да = забранява редактирането / Не = разрешава редактирането');
define('MODULE_SYSTEM_REQSER_SANITIZE_STRINGS_TITLE', 'Трябва ли "scripte" и "iframe" да бъдат премахнати от текстовете?');
define('MODULE_SYSTEM_REQSER_SANITIZE_STRINGS_DESC', 'Ако в текстовете са включени например видеоклипове от YouTube или анимации, тези тагове не трябва да се премахват. В противен случай редактираните от нас текстове могат да загубят своята функционалност.<br />Да = Премахнете / Не = Не премахвайте');
...
define('MODULE_SYSTEM_REQSER_TABLE_NOT_EXIST_ERR', 'Ръчно добавената таблица <b>"%s"</b> не може да бъде намерена в базата данни.' . MODULE_SYSTEM_REQSER_MORE_TABLES_TITLE . ' Моля, проверете настройките за " "!');
...
define('MODULE_SYSTEM_REQSER_ADMIN_CATEGORIES_SEO_SETTINGS_LOADING', 'SEO настройките се зареждат, моля, изчакайте.');
define('MODULE_SYSTEM_REQSER_ADMIN_CATEGORIES_SEO_FORM_PARAMS_MISSING', 'Записите ви не са пълни, моля, проверете:');