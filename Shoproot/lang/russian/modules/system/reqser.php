...
define('MODULE_SYSTEM_REQSER_REQSER_API_KEY_TITLE', 'Ключ API Reqser');
...
define('MODULE_SYSTEM_REQSER_ALLOW_ALL_ROW_ACCESS_DESC', '"Да" дает Reqser доступ ко всем записям колонок освобожденных таблиц, "Нет" может привести к ошибкам при работе со старыми версиями магазинов или при использовании нестандартных шаблонов.');
...
define('MODULE_SYSTEM_REQSER_ADD_LANGUAGE_ALLOWED_TITLE', '<hr /><h2>Дополнительные настройки</h2>Следует ли разрешить добавление нового языка в <i><a href="https://reqser.com/" target="_blank">reqser.com</i></a>?');
