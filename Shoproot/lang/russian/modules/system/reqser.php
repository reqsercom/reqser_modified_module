...
***********************************************************/
define('MODULE_SYSTEM_REQSER_TITLE', 'AI-инструменты для переводов и SEO через Reqser <i>.</i>com, версия модуля %s<br />- сборка для <i>Reqser</i>.com -<br />&copy; <a href="http://www.revilonetz.de/kontakt" target="_blank" title="Kontaktiere noRiddle" style="color:#02afc3;">noRiddle</a> и &copy; <a href="https://www.reqser.com" target="_blank" title="Kontaktiere Reqser" style="color:#02afc3;">Reqser.com</a> ' . date('m-Y') . '(07-2023 - )');
define('MODULE_SYSTEM_REQSER_DESCRIPTION', '
<a href="https://www.reqser.com" target="_blank"><img src="images/reqser_modul/modul_logo.png" border=0 width="400px"></a></br> Системный модуль для связи с DeepL, OpenAI и Neuroflash через <i><a href="https://reqser.com/" target="_blank">reqser.com</a></i>');
...
define('MODULE_SYSTEM_REQSER_DISABLE_BASE_LANGUAGE_EDIT_TITLE', 'Предотвратить редактирование основного языка?');
define('MODULE_SYSTEM_REQSER_DISABLE_BASE_LANGUAGE_EDIT_DESC', 'Редактирование основного языка должно быть разрешено, чтобы поисковая оптимизация текстов могла осуществляться на основном языке.<br />Да = Запретить редактирование / Нет = Разрешить редактирование');
define('MODULE_SYSTEM_REQSER_SANITIZE_STRINGS_TITLE', 'Следует ли убрать из текстов слова "scripte" и "iframe"?');
define('MODULE_SYSTEM_REQSER_SANITIZE_STRINGS_DESC', 'Если в тексты включены, например, видео с YouTube или анимация, эти теги удалять не следует. В противном случае редактируемые нами тексты могут потерять функциональность.<br />Да = Удалить / Нет = Не удалять');
...
define('MODULE_SYSTEM_REQSER_TABLE_NOT_EXIST_ERR', 'Добавленная вручную таблица <b>"%s"</b> не найдена в базе данных.' . MODULE_SYSTEM_REQSER_MORE_TABLES_TITLE . ' Пожалуйста, проверьте настройки для " "!');
...
define('MODULE_SYSTEM_REQSER_ADMIN_CATEGORIES_SEO_SETTINGS_LOADING', 'Настройки SEO загружаются, пожалуйста, подождите.');
define('MODULE_SYSTEM_REQSER_ADMIN_CATEGORIES_SEO_FORM_PARAMS_MISSING', 'Ваши записи не заполнены, пожалуйста, проверьте:');