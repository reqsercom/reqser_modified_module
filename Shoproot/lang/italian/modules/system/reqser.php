...
define('MODULE_SYSTEM_REQSER_TABLE_NOT_EXIST_ERR', 'La tabella aggiunta manualmente <b>"%s"</b> non &egrave; stata trovata nel database. Controllare le impostazioni di "' . MODULE_SYSTEM_REQSER_MORE_TABLES_TITLE . '"!');
