...
define('MODULE_SYSTEM_REQSER_REQSER_API_KEY_DESC', 'Here you can enter the API key from <i>Reqser.com</i>. Displayed when connecting to Modified on Reqser. <a href="https://www.reqser.com/translation/new-website/Modified" target="_blank" title="Direkt Link">&amp;raquo Direct link here</a> ');
...
define('MODULE_SYSTEM_REQSER_TABLE_NOT_EXIST_ERR', 'The manually added table <b>"%s"</b> could not be found in the database. Please check the settings for "' . MODULE_SYSTEM_REQSER_MORE_TABLES_TITLE . '"!');
