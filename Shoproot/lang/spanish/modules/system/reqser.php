...
***********************************************************/
define('MODULE_SYSTEM_REQSER_TITLE', 'Herramientas de IA para traducciones y SEO a trav&eacute;s de Reqser <i>.</i>com, m&oacute;dulo versi&oacute;n %s<br />- construir para <i>Reqser</i>.com -<br />&copy; <a href="http://www.revilonetz.de/kontakt" target="_blank" title="Kontaktiere noRiddle" style="color:#02afc3;">noRiddle</a> y &copy; <a href="https://www.reqser.com" target="_blank" title="Kontaktiere Reqser" style="color:#02afc3;">Reqser.com</a> ' . date('m-Y') . '(07-2023 - )');
define('MODULE_SYSTEM_REQSER_DESCRIPTION', '
<a href="https://www.reqser.com" target="_blank"><img src="images/reqser_modul/modul_logo.png" border=0 width="400px"></a></br> M&oacute;dulo del sistema para la conexi&oacute;n con DeepL, OpenAI y Neuroflash a trav&eacute;s de <i><a href="https://reqser.com/" target="_blank">reqser.com</a></i>');
...
define('MODULE_SYSTEM_REQSER_REQSER_API_KEY_DESC', 'Aqu&iacute; puedes introducir la clave API de <i>Reqser.com</i>. Se muestra cuando se conecta a Modificado en Reqser. <a href="https://www.reqser.com/translation/new-website/Modified" target="_blank" title="Direkt Link">&amp;raquo Enlace directo aqu&iacute;</a> ');
...
define('MODULE_SYSTEM_REQSER_ADD_LANGUAGE_ALLOWED_TITLE', '<hr /><h2>Otros ajustes</h2> <i><a href="https://reqser.com/" target="_blank"></i></a> &iquest;Deber&iacute;a a&ntilde;adirse un nuevo idioma a <i>reqser.</i>com?');
