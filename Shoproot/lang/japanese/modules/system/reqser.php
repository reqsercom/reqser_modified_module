...
***********************************************************/
define('MODULE_SYSTEM_REQSER_TITLE', 'reqser<i>.</i>com経由の翻訳とSEOのためのAIツール、モジュールバージョン%s。<br /><i>- reqser</i>.comのためのビルド - 。<br />&copy;<a href="http://www.revilonetz.de/kontakt" target="_blank" title="Kontaktiere noRiddle" style="color:#02afc3;">noRiddle</a>と&copy;<a href="https://www.reqser.com" target="_blank" title="Kontaktiere Reqser" style="color:#02afc3;">reqser.com</a>。' . date('m-Y') . '(07-2023 - )');
define('MODULE_SYSTEM_REQSER_DESCRIPTION', '
<a href="https://www.reqser.com" target="_blank"><img src="images/reqser_modul/modul_logo.png" border=0 width="400px"></a></br>
<i><a href="https://reqser.com/" target="_blank">reqser.com</i>経由でDeepL、OpenAI、Neuroflashと接続するためのシステムモジュール<i></a></i>');
...
define('MODULE_SYSTEM_REQSER_REQSER_API_KEY_DESC', '<i>reqser.comの</i>APIキーを入力します。reqserでModifiedに接続する際に表示されます。<a href="https://www.reqser.com/translation/new-website/Modified" target="_blank" title="Direkt Link"></a> 直接リンクはこちら');
...
define('MODULE_SYSTEM_REQSER_LESS_TABLES_DESC', '翻訳から除外するテーブルをカンマで区切ってここに入力します。<br />(上記ですべての標準テーブルが選択され、そのうちのいくつかが除外される場合にのみ必要です)。');
...
define('MODULE_SYSTEM_REQSER_ADD_LANGUAGE_ALLOWED_DESC', '<a href="https://reqser.com/" target="_blank"></a> この設定を「はい」にすると、新しい言語を<i>reqser.comに</i>追加することができます。<br />いいえ "の場合、その言語はすでにショップシステムに存在し、このモジュールで有効化されている必要があります。<br />ショップに言語を作成する：<a href="' . DIR_WS_ADMIN . FILENAME_LANGUAGES . '">ショップに言語を作成しますか？</a> &nbsp;&nbsp;<span class="alrt">!!新しい言語は24-48時間後にショップで利用可能になります。!!</span><br />翻訳する言語としてここをマークしてください。');
define('MODULE_SYSTEM_REQSER_LANGUAGE_FILES_TITLE', '' . draw_tooltip('サーバー上の言語ファイルを翻訳しますか？ サーバー上のすべてのファイルが照会され、翻訳されます</br>これはモジュールと拡張機能の言語ファイルにも適用されます。既存の言語も含め、すべての言語ファイルが再生成されます。<br />デフォルトでは、reqserの既存の外国語テキストは採用され、新たに翻訳されませんが、reqser設定で変更できます。'));
...
define('MODULE_SYSTEM_REQSER_TABLE_NOT_EXIST_ERR', '手動で追加したテーブル<b>"%s"</b>がデータベースに見つかりませんでした。の設定を確認してください！');
