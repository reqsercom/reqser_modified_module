...
***********************************************************/
define('MODULE_SYSTEM_REQSER_TITLE', 'Teko&auml;lyty&ouml;kalut k&auml;&auml;nn&ouml;ksille ja SEO:lle Reqser <i>.</i>comin kautta, moduuliversio %s<br />- build for <i>Reqser</i>.com -<br />&copy; <a href="http://www.revilonetz.de/kontakt" target="_blank" title="Kontaktiere noRiddle" style="color:#02afc3;">noRiddle</a> ja &copy; <a href="https://www.reqser.com" target="_blank" title="Kontaktiere Reqser" style="color:#02afc3;">Reqser.com</a> ' . date('m-Y') . '(07-2023 - )');
define('MODULE_SYSTEM_REQSER_DESCRIPTION', '
<a href="https://www.reqser.com" target="_blank"><img src="images/reqser_modul/modul_logo.png" border=0 width="400px"></a></br> J&auml;rjestelm&auml;moduuli yhteyden muodostamiseksi DeepL, OpenAI:n ja Neuroflashin kanssa <i><a href="https://reqser.com/" target="_blank">reqser.com</i>:n kautta <i></a></i>');
...
define('MODULE_SYSTEM_REQSER_TEMP_SHOP_TOKEN_DESC', 'V&auml;liaikainen turvakoodi kauppaan teht&auml;vi&auml; ulkoisia kyselyj&auml; varten.<br /><span  class="alrt">M&auml;&auml;ritet&auml;&auml;n automaattisesti !</span>');
...
define('MODULE_SYSTEM_REQSER_TABLE_NOT_EXIST_ERR', 'Manuaalisesti lis&auml;tty&auml; taulukkoa <b>"%s</b> " ei l&ouml;ydy tietokannasta.' . MODULE_SYSTEM_REQSER_MORE_TABLES_TITLE . ' Tarkista asetukset " "!');
